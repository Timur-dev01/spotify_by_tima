...
const Login: React.FC = () => {
  const spotify = {
    ...
    redirect_uri: "https://spotify-copy-by-tima.netlify.app/",
    auth_endpoint: "https://accounts.spotify.com/authorize",
    response_type: "token",
    scope: "playlist-modify-public user-read-private user-read-email"
  };

  const loginUrl = `${spotify.auth_endpoint}?client_id=${spotify.client_id}&redirect_uri=${spotify.redirect_uri}&response_type=${spotify.response_type}&scope=${encodeURIComponent(spotify.scope)}`;
